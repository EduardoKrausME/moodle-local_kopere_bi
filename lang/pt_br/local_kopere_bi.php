...
$string['c_enablecompletion'] = 'Completude habilitada';
...
$string['class_not_found'] = 'Classe não localizada';
...
$string['page_title_edit'] = 'Editar título desta página';
$string['page_title_export'] = 'Exportar página';
$string['pie_desc'] = 'Monta um gráfico de pizza';
$string['pie_name'] = 'Gráfico de pizza';
$string['pie_sql_warning'] = '<p>A SQL abaixo deve retornar apenas duas colunas.</p>
<p>A primeira coluna será o nome da coluna e a segunda coluna deve ser um valor numérico.</p>';
...
$string['report_9_category_desc'] = 'Relatório dos módulos do curso';
