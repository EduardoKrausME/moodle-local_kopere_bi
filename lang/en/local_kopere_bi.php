...
$string['l_ip'] = 'IP';
$string['l_objecttable'] = 'Module name';
...
$string['report_1_courses'] = 'Courses';
...
$string['report_4_cat_description'] = 'Enrollment reports, covering history, current status, and course enrollment trends.';
