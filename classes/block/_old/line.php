...
class line implements i_type {
    ...
    public function edit(form $form, $koperebielement) {
        $values = [
            ["key" => "line", "value" => self::get_name()],
            ["key" => "area", "value" => area::get_name()],
            ["key" => "column", "value" => column::get_name()],
        ];
        $names = [
            "line" => self::get_name(),
            "area" => area::get_name(),
        ...
        message::print_warning(get_string("line_sql_warning", "biblocks_line"));
            ...
            code_util::options($form, trim("
{
    ...
    public function preview($koperebielement) {
        ...
        $data = [
            "ajax_url" => url_util::makeurl(
                "bi-chart_data",
                "load_data",
                ["item_id" => $koperebielement->id],
                "view-ajax"
            ),
