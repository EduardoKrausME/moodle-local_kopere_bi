...
$string['maps_sql_warning'] = '<p>Recuerda que el SQL siguiente debe devolver solo una columna, y esa columna debe contener una IP válida.<br>Ejemplo: el SQL <code>SELECT lastip FROM {user} WHERE lastaccess > UNIX_TIMESTAMP() - (10 * 60)</code> devuelve todos los estudiantes que ingresaron a Moodle en los últimos 10 minutos</p>';
